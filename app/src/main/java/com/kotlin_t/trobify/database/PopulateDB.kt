...
class PopulateDB(
    ...
    fun createInmueble(i: Int) {
        ...
        var direcciones = listOf(
            ...
            "Chalet adosado en venta en Lepanto, 16\n",
            "Chalet adosado en venta en Plaza de la Gavidia-San Lorenzo\n",
            "Ático en venta en calle Tabladilla\n",
            "Piso en venta en Arenal - Museo - Tetuán\n",
            "Chalet adosado en venta en calle Victoria Kent Park, 31\n",
            "Piso en venta en avenida Grupo Parqueflores Fase 2\n",
            "Piso en venta en calle Alhondiga\n",
            "Piso en venta en calle Pascual de Gayangos\n",
            "Piso en venta en calle Dos de Mayo\n",
            "Casa o chalet independiente en venta en Urbanización Flor del Loreto, 27\n",
            "Casa o chalet en venta en calle Magallanes, 2\n",
            "Chalet pareado en venta en Los Rosales\n",
            "Chalet adosado en venta en calle AZORIN\n",
            "Casa o chalet independiente en venta en calle Sierra Magina\n",
            "Dúplex en venta en calle Almirante Espinosa\n",
            "Casa o chalet independiente en venta en SANTIAGO\n",
            "Piso en venta en Gran Via Juan Carlos I\n",
            ...
            "Piso en venta en Casco Antiguo\n",
            "Piso en venta en Portillejo - Valdegastea\n",
            "Casa o chalet en venta en calle Albariño\n",
            "Casa o chalet en venta en travesía Palencia\n",
            "Casa o chalet en venta en P-901\n",
            ...
            "Piso en venta en plaza San Pablo\n",
